...
export default function GiftsSection() {
  ...
  return (
    <section id="regalos" className="scroll-mt-32 bg-[#fbfaf8] px-6 py-18">
      <div className="mx-auto max-w-[500px]">
        ...
        {view === "list" && (
          <>
            ...
            <div className="mt-10 max-h-[60dvh] space-y-4 overflow-y-auto overscroll-contain pb-28 pr-1 sm:max-h-[720px]">
